...
import { cacheCipher, SHOULD_ENABLE_STORAGE_ENCRYPTION } from './encryptionSetting'
 ...
 * 自定义序列化器，用于序列化和反序列化存储数据 // dev环境不加密
 *
...
//   console.error(keyPrefix) // persist.ts:72 C3超时管理系统__DEVELOPMENT
  return {
